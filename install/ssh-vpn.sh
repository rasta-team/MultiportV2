...
commonname="rasta-team"
email="admin@rasta-team.com"

# // simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/rasta-team/MultiportV2/main/password"
...
# // install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/rasta-team/MultiportV2/main/badvpn-udpgw64"
...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/rasta-team/MultiportV2/main/squid3.conf"
...
# // OpenVPN
wget https://raw.githubusercontent.com/rasta-team/MultiportV2/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh

# // install lolcat
wget https://raw.githubusercontent.com/rasta-team/MultiportV2/main/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/rasta-team/MultiportV2/main/banner/bannerssh.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

# // Bannerku menu
wget -O /usr/bin/bannerku https://raw.githubusercontent.com/rasta-team/MultiportV2/main/banner/bannerku && chmod +x /usr/bin/bannerku

# // install bbr
wget https://raw.githubusercontent.com/rasta-team/MultiportV2/main/system/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O clearcache "https://raw.githubusercontent.com/rasta-team/MultiportV2/main/clearcache.sh"
